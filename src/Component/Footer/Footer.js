...
const Footer = () => {
    return (
        <div className='mt-[29px] bg-[#002699] h-[507px] relative overflow-hidden'>
            ...
            <div className='mx-[320px] flex justify-between items-center gap-[335px] pt-[23px]'>
                ...
                <div className='flex justify-between  justify-items-center items-center  w-[60%]'>
                    ...
                    <div>
                        <h3 className='text-[18px] font-[500]'>Call Us <br /> <span className='font-[600]'>01698 458 1538</span> </h3>
                    </div>
                    <div>
