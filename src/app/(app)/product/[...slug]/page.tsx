...
import { ChevronRightIcon, LucideMessageCircleWarning, MoreHorizontal } from "lucide-react";
                ...
                <div className="space-y-14">
                    <section>
                                    ...
                                    <TableRow key={i}>
                                        ...
                                        <TableCell>
                                            <div className="flex gap-1">
                                                ...
                                                {p.oldPrice && <p className="text-base line-through">{p.oldPrice}</p>}
                                            </div>
                                            <p className="text-xs text-muted-foreground font-light mt-[-5px]">{p.eachPrice}</p>
                                        </TableCell>
                                        <TableCell />
                                        <TableCell>
                        ...
                        <div className="flex gap-2 pt-5">
                            ...
                            <p className="text-sm text-black">The prices shown above are available online and may not reflect in store.</p>
                        </div>
                    </section>
                    <section>
                        <div className="justify-between font-bold text-2xl mb-3">
